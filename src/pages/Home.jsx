...
const apiCall = async (setIsLoading, userInput) => {
    try {
      const response = await axios.post('http://localhost:5000/generate-meditation', {
        userInput,
      });
...
const Home = () => {
    ...
    const [generatedMeditation, setGeneratedMeditation] = useState('lorem ipsme  kdfjk jdskf jskdlafj sdskdj flkdsfjksldjfkd kfjsdaf ;slkdj ksdjfk');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const response = await apiCall(setIsLoading, userInput);
    ...
    return (
        <div className='home'>
            ...
            { <MeditationResult generatedMeditation={generatedMeditation} />}
        </div>
    );
};
